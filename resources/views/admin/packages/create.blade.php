...
<div class="card p-6">
    <div class="flex items-center justify-between mb-6">
        <h3 class="text-lg font-semibold text-gray-900 mb-6">Tambah Package Baru</h3>
    </div>
        ...
        <div class="mb-4 flex space-x-6">
            <div class="flex items-center">
                <input type="checkbox" name="is_popular" id="is_popular" 
                       class="h-4 w-4 text-yellow-600 border-gray-300 rounded" {{ old('is_popular') ? 'checked' : '' }}>
                <label for="is_popular" class="ml-2 block text-sm text-gray-700">Popular</label>
            </div>
            <div class="flex items-center">
                <input type="checkbox" name="is_active" id="is_active" 
                       class="h-4 w-4 text-green-600 border-gray-300 rounded" {{ old('is_active', true) ? 'checked' : '' }}>
